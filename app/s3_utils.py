...
def save_response_s3(client, file, key):
    ...
    in_mem_file.seek(0)
    upload_file_s3(client, in_mem_file, 'fotomaker-engineering', key)
    return None


@report_error(332)
def upload_file_s3(client, in_mem_file, bucket, key):
    client.upload_fileobj(in_mem_file, bucket, key)
    return None
